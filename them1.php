...
<body>
       ...
       $loaikh = $_POST['loaikh'];
        ...
        if (trim($ch) == "" || trim($daa) == "" || trim($dab) == "" || trim($dac) == "" || trim($dad) == "" || trim($da) == "") {
            ...
            if ($count < 1) {
                ...
                VALUES('$ch',$loaikh,'1','$capdo','mutiple choice')";
    ...
    <form action="" method="post">
        <h3>Multiple Choice</h2>
            ...
            Đáp án:
            A<input type="radio" name="da" value="a" <?php if (isset($_POST['da']) && $da == "a") echo "checked"; ?>>
            B<input type="radio" name="da" value="b" <?php if (isset($_POST['da']) && $da == "b") echo "checked"; ?>>
            C<input type="radio" name="da" value="c" <?php if (isset($_POST['da']) && $da == "c") echo "checked"; ?>>
            D<input type="radio" name="da" value="d" <?php if (isset($_POST['da']) && $da == "d") echo "checked"; ?>>
            <br>
