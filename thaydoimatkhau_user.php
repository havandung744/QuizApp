...
<body>
        ...
        if(trim($_POST['pass_cu'])=="" || trim($_POST['pass'])=="" || trim($_POST['pass1'])==""){
            ...
            if ($_SESSION['pass'] != $_POST['pass_cu']) {
                ...
                $_SESSION['tb'] = "mật khẩu cũ và mật khẩu thay đổi bị trùng nhau";
                        ...
                        $result = mysqli_query($conn, "UPDATE users SET user_pass='$pass' where level='0' and user_name='$user_name'");
    ...
    <form action="" method="post" align="center">
        ...
        ?>
        <br>
        mật khẩu cũ <input type="password" name="pass_cu" >
        <br>
        mật khẩu mới <input type="password" name="pass">
        <br>
